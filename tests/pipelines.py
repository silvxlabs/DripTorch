...
def generate_simulations(
    ...
    **kwargs
    ...
    if ignitor_depth:
        ...
        simulation_data["flank_pattern"] = flank_pattern.to_json()
    ...
    if ignitor_depth and ignitor_spacing:
        ...
        simulation_data["strip_pattern"] = strip_pattern.to_json()
